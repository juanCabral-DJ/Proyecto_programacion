...
public class BorrarProducto extends JFrame {
	...
	public BorrarProducto(SistemaGUI sistema) throws SQLException {
	    ...
	    panel.setBounds(0, 0, 287, 140);
	    getContentPane().add(panel);
	    panel.setLayout(null);
	    
	    JLabel lblNewLabel = new JLabel("Ingrese el id del producto a borrar:");
	...
	public void Borrar() throws SQLException{
		...
		if(id > 0) {
			...
			throw new SQLException("No es posible Borrar este Producto, no existe");
		}
	}
}
